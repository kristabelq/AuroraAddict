    ...
    <div className="min-h-screen bg-gradient-to-b from-black via-purple-950/20 to-black pb-24">
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-6 mb-6">
          {/* Instagram-style: Profile Image LEFT, Stats RIGHT */}
          <div className="flex items-center gap-5 sm:gap-8 mb-6">
            {/* Profile Image */}
            <div className="flex-shrink-0">
              <div className="relative w-20 h-20 sm:w-24 sm:h-24 rounded-full overflow-hidden ring-2 ring-white/20">
                {profile.image ? (
                  <Image
                    src={profile.image}
            ...
            {/* Stats - 2 rows on mobile, 1 row on desktop */}
            <div className="flex-1">
              <div className="grid grid-cols-3 sm:grid-cols-6 gap-2 sm:gap-4">
                ...
                <div className="text-center">
                  <div className="text-lg sm:text-xl font-bold text-aurora-green">
                    {profile.averageSuccessRate > 0 ? `${profile.averageSuccessRate.toFixed(0)}%` : '-'}
                  </div>
          ...
          <div className="mb-4">
            <div className="flex items-center gap-2 mb-1">
              ...
              {profile.userType === "business" && profile.verificationStatus === "verified" && (
                <div
                  className="flex items-center gap-1 px-2 py-0.5 bg-blue-500/20 border border-blue-500 rounded-full"
          ...
          <div className="flex gap-2">
            ...
            <button
              ...
              className="flex-1 px-4 py-2 bg-white/10 hover:bg-white/20 text-white rounded-lg text-sm font-semibold transition-colors"
            >
              Share profile
            </button>
          </div>
